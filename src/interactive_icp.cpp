...
*/
    ...
    pcl::io::loadPCDFile (argv[2], *cloud_icp);
...
//    grid.filter (*cloud_icp);
    ...
    *cloud_tr = *cloud_icp; // We backup cloud_icp into cloud_tr for later use
    ...
    icp.setTransformationEpsilon (9e-7);
    icp.setMaxCorrespondenceDistance (0.05); //old : 30Jul 0.08
...
//              icp.setMaxCorrespondenceDistance (icp.getMaxCorrespondenceDistance () - 0.0001);

//            std::cout<<"Last incrementalTransformation:"<<std::endl;
//            printMatix4f(icp.getLastIncrementalTransformation());
//            std::cout<<"Prev matrix:"<<std::endl;
//            printMatix4f(prev);
            //std::cout << std::fixed;
            std::cout<<"Fabs div:"<<fabs ((icp.getLastIncrementalTransformation () - prev).sum ())<<std::endl;
            std::cout<<"MaxCorrenspondeceDistance:"<<icp.getMaxCorrespondenceDistance()<<std::endl;
            if (fabs ((icp.getLastIncrementalTransformation () - prev).sum()) < icp.getTransformationEpsilon ())
...
//                viewer.updatePointCloud (cloud_icp, cloud_icp_color_h, "cloud_icp_v2");
                ...
                ss << ".pcd";
                *cloud_icp+=*cloud_in;
                pcl::io::savePCDFile (ss.str (), *cloud_icp, true);
                PCL_ERROR ("\nICP has not converged.\n");
                return -1;
            }
